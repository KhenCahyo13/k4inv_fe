...
const Landing = () => {
    ...
    return (
        ...
        <section className="navbar-box">
            ...
            <button className="px-3 py-1 mt-3 bg-blue-400 rounded-md shadow-md shadow-blue-400 text-[13px] text-gray-100 hover:bg-blue-500 hover:shadow-blue-500 transition duration-300"><Link to='/login'>Login</Link></button>
        </section>            
        {/* Section Hero */}
        <section className="mt-6 lg:h-[260px]">
            ...
            <div className="flex flex-col justify-center md:justify-start md:px-10 lg:px-32 lg:mt-8">
                <h1 className="text-center text-gray-100 font-semibold md:text-left md:text-xl lg:text-3xl">Selamat Datang,<br />Buat Undangan Anda Sekarang Juga</h1>
                ...
                <button className="mt-3 w-[38%] mx-auto bg-blue-400 text-center text-[12px] px-4 py-2 rounded-md shadow-md shadow-blue-400 text-gray-100 hover:bg-blue-500 hover:shadow-blue-500 transition duration-300 md:mx-0 md:w-[24%] lg:text-sm lg:mt-5"><Link to='/login'>Buat Undangan</Link></button>
            </div>
        ...
        <section className="bg-cream-100 w-full px-6 pt-4 pb-8 mt-12 md:pt-8 lg:px-24 lg:gap-12 lg:pb-14">
            ...
            <div data-aos="fade-up" className="mt-6 md:flex md:flex-row-reverse md:gap-8 md:mx-12 md:items-center md:mt-8 lg:mx-32 lg:mt-14">
                ...
                <div className="md:block">
                    ...
                    <button className="mt-3 w-[38%] block mx-auto bg-blue-400 text-center text-[12px] px-4 py-2 rounded-md shadow-md shadow-blue-400 text-gray-100 hover:bg-blue-500 hover:shadow-blue-500 transition duration-300 md:mx-0 lg:w-[28%] lg:text-sm"><Link to='/login'>Lihat Sekarang</Link></button>
                </div>
            </div>
